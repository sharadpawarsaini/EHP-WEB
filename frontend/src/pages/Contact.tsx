  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0A0A0A] transition-colors duration-500 overflow-x-hidden selection:bg-blue-500/30">
      ...
      <div className="absolute top-0 left-0 w-full h-[1000px] pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[10%] -right-[10%] w-[60%] h-[70%] bg-indigo-600/10 dark:bg-indigo-600/5 blur-[120px] rounded-full animate-pulse delay-700"></div>
      </div>
      ...
      <main className="relative pt-40 pb-32">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            >
              <div>
                <div className="inline-flex items-center gap-3 bg-indigo-50 dark:bg-indigo-600/10 px-6 py-2.5 rounded-full border border-indigo-100 dark:border-indigo-600/20 mb-8">
                   <MessageSquare className="h-4 w-4 text-indigo-600" />
                   <span className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-600">Communication Hub</span>
                </div>
              ...
              <div className="space-y-8">
                {[
                  { icon: Mail, label: 'Neural Mail', val: 'sharadpawarsaini@gmail.com', color: 'text-blue-500', bg: 'bg-blue-50 dark:bg-blue-900/20' },
                  { icon: Phone, label: 'Direct Line', val: 'Available 09:00 - 18:00 IST', color: 'text-purple-500', bg: 'bg-purple-50 dark:bg-purple-900/20' },
              ...
              <form className="space-y-8 relative z-10">
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <input 
                      type="text" 
                      className="w-full p-5 rounded-2xl bg-gray-50 dark:bg-[#050505] border border-gray-100 dark:border-white/10 font-bold text-gray-900 dark:text-white outline-none focus:ring-4 focus:ring-blue-500/10 transition-all" 
                ...
                <div className="space-y-3">
                  ...
                  <textarea 
                    rows={5} 
                    className="w-full p-6 rounded-[2rem] bg-gray-50 dark:bg-[#050505] border border-gray-100 dark:border-white/10 font-bold text-gray-900 dark:text-white outline-none focus:ring-4 focus:ring-blue-500/10 transition-all" 
