    ...
    <div className="min-h-screen relative font-sans text-slate-900 dark:text-slate-100 overflow-x-hidden bg-slate-50 dark:bg-[#020617] transition-colors duration-500 medical-grid">
          ...
          <div className="hidden md:flex items-center gap-10">
            {['About', 'FAQ', 'Contact'].map((item) => (
              <Link 
                key={item} 
                to={`/${item.toLowerCase()}`} 
                className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
              >
                {item}
              </Link>
            ))}
            ...
            <div className="hidden sm:flex bg-gray-100 dark:bg-white/5 p-1 rounded-xl border border-gray-200 dark:border-white/10">
              {['en', 'hi'].map((lang) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-[9px] font-black transition-all uppercase ${i18n.language.startsWith(lang) ? 'bg-white dark:bg-white/10 text-primary-600 dark:text-white shadow-xl' : 'text-gray-400 hover:text-gray-600'}`}
                >
                  {lang}
                </button>
              ))}
          ...
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="fixed inset-0 z-[90] bg-white dark:bg-[#0A0A0A] pt-24 px-6">
             <div className="flex flex-col gap-8">
                ...
                <div className="pt-10 flex flex-col gap-4">
                   ...
                   <Link to="/register" className="w-full py-5 text-center font-black uppercase tracking-widest bg-primary-600 text-white rounded-2xl">Get Started</Link>
                </div>
             </div>
          </motion.div>
        )}
      ...
      <main className="relative pt-32 sm:pt-48">
        ...
        <section className="max-w-7xl mx-auto px-6 text-center">
           <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="inline-flex items-center gap-3 bg-primary-50 dark:bg-primary-600/10 px-6 py-2.5 rounded-full border border-primary-100 dark:border-primary-600/20 mb-10">
           ...
           <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="flex flex-col sm:flex-row justify-center gap-6">
              <Link to="/register" className="bg-primary-600 text-white px-12 py-6 rounded-[1.5rem] font-black text-xs uppercase tracking-[0.3em] shadow-[0_20px_50px_rgba(5,150,105,0.3)] hover:scale-105 active:scale-95 transition-all">
        ...
        <section className="mt-48 pb-48 max-w-7xl mx-auto px-6 text-center">
           <div className="relative py-32 rounded-[4rem] bg-gradient-to-br from-primary-600 to-emerald-700 overflow-hidden shadow-3xl shadow-primary-600/20">
              ...
              <div className="relative z-10 max-w-3xl mx-auto px-6">
                 ...
                 <p className="text-xl text-primary-100/80 font-medium mb-12">Join the global network of secure medical identifiers. It's fast, free, and life-critical.</p>
      ...
      <footer className="bg-gray-50 dark:bg-[#050505] border-t border-gray-100 dark:border-white/5 py-20">
            ...
            {['Product', 'Company'].map((title, i) => (
              <div key={i}>
                 ...
                 <ul className="space-y-4">
                    {title === 'Product' ? (
                      <>
                        <li><Link to="/register" className="text-sm font-bold text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">Create Profile</Link></li>
                        <li><Link to="/faq" className="text-sm font-bold text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">How it Works</Link></li>
                        <li><Link to="/about" className="text-sm font-bold text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">The Protocol</Link></li>
                      </>
                    ) : (
                      <>
                        <li><Link to="/contact" className="text-sm font-bold text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">Contact Support</Link></li>
                        <li><Link to="/faq" className="text-sm font-bold text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">Documentation</Link></li>
                        <li><Link to="/login" className="text-sm font-bold text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors">Security</Link></li>
                      </>
                    )}
                 </ul>
              </div>
         ...
         <div className="max-w-7xl mx-auto px-6 mt-20 pt-10 border-t border-gray-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-8">
               <Link to="/privacy" className="text-[10px] font-black text-gray-400 hover:text-primary-600 cursor-pointer transition-colors uppercase tracking-widest">Privacy</Link>
               <Link to="/terms" className="text-[10px] font-black text-gray-400 hover:text-primary-600 cursor-pointer transition-colors uppercase tracking-widest">Terms</Link>
            </div>
         </div>
      </footer>
