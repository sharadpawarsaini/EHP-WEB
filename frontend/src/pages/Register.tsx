    ...
    <div className="min-h-screen relative flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 overflow-hidden bg-zinc-50 dark:bg-zinc-950 transition-colors duration-500">
      ...
      <AnimatePresence>
        {isGoogleLoading && (
          ...
          >
            ...
            <p className="mt-6 text-sm font-semibold text-zinc-800 dark:text-zinc-200">Setting up your passport...</p>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="max-w-2xl w-full relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-zinc-900 dark:text-white tracking-tight mb-2">Create Your Health Passport</h2>
          <p className="text-zinc-500 dark:text-zinc-400 font-medium">Get secure access to your medical history anywhere.</p>
        </motion.div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="space-y-1.5">
                  <label className="text-sm font-semibold text-zinc-700 dark:text-zinc-300 ml-1">Gender</label>
                  <select
                    value={gender}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="space-y-1.5">
                  <label className="text-sm font-semibold text-zinc-700 dark:text-zinc-300 ml-1">Blood Group</label>
                  <select
                    required
                    value={bloodGroup}
        ...
        >
          <p className="text-sm font-medium text-zinc-500 dark:text-zinc-400">
            ...
            <Link to="/login" className="text-primary-600 font-semibold hover:text-primary-700 transition-colors">Sign in here</Link>
          </p>
        </motion.div>
      </div>
    </div>
