    ...
    <div className="space-y-10 animate-in fade-in duration-700 max-w-full overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
         <div>
            <div className="flex items-center gap-2 mb-3">
               <span className="px-3 py-1 bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 text-[10px] font-black uppercase tracking-widest rounded-full">Secure Bridging</span>
         ...
         <div className="flex items-center gap-4 p-4 bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-2xl border border-white dark:border-slate-700 shadow-sm">
            <div className="flex -space-x-2">
               <div className="w-8 h-8 rounded-full bg-primary-500 border-2 border-white dark:border-slate-800 flex items-center justify-center text-[10px] font-bold text-white">G</div>
      ...
      <div className="grid lg:grid-cols-3 gap-10">
         ...
         <div className="space-y-8">
            <div className="bg-gradient-to-br from-emerald-600 to-primary-700 rounded-[3rem] p-10 text-white relative overflow-hidden shadow-2xl">
               <div className="absolute top-0 right-0 p-12 opacity-10">
                  <Globe className="h-40 w-40" />
               </div>
               <h3 className="text-2xl font-black mb-8 flex items-center gap-3">
                  <Radio className="h-6 w-6 text-primary-300" />
                  Live Sync
               </h3>
               <p className="text-primary-50/80 text-sm font-medium leading-relaxed mb-8">
               ...
               <div className="space-y-4">
                  <div className="p-4 bg-white/10 rounded-2xl border border-white/10 flex items-center justify-between group cursor-pointer hover:bg-white/20 transition-all">
                     ...
                     <span className="text-[10px] font-black text-primary-300">Every 15m</span>
                  </div>
                  <div className="p-4 bg-white/10 rounded-2xl border border-white/10 flex items-center justify-between group cursor-pointer hover:bg-white/20 transition-all">
                     <span className="text-[10px] font-black uppercase tracking-widest">Data Retention</span>
                     <span className="text-[10px] font-black text-primary-300">90 Days</span>
                  </div>
               </div>
            </div>
            ...
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl p-8 rounded-[3rem] border border-white dark:border-slate-700 shadow-xl">
               ...
               <button className="w-full py-4 border-2 border-dashed border-gray-100 dark:border-slate-700 rounded-2xl text-xs font-black uppercase tracking-widest text-gray-400 hover:border-emerald-600 hover:text-emerald-600 transition-all">
                  Documentation
               </button>
            </div>
         </div>
      ...
      <div className="p-8 bg-primary-50 dark:bg-primary-900/10 rounded-[2.5rem] border border-primary-100 dark:border-primary-900/30 flex items-start gap-5">
         ...
         <div>
            <p className="text-sm font-black text-primary-900 dark:text-primary-300 uppercase tracking-widest mb-1">Authorization Protocol</p>
            <p className="text-xs text-primary-700 dark:text-primary-400 leading-relaxed font-medium">EHP uses standard OAuth 2.0 authorization codes. We never store your third-party passwords. Access tokens are encrypted using AES-256 and rotated automatically every 24 hours.</p>
         </div>
      </div>
    </div>
  );
